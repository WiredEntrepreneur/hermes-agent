...
DEFAULT_CONFIG = {
    ...
    "kanban": {
        # Explicit per-assignee external worker routes.  Empty disables the
        # external CLI lane entirely; adapter names are resolved by a
        # code-controlled registry, never a config-supplied command.
